...
while i < len(data):
  if data[i] == 1:
    ...
    data[data[i + 1]] = input_num
    i += 2
  elif data[i] == 4:
    if data[data[i + 1]] != 10:
      area += chr(data[data[i + 1]])
    i += 2
  elif data[i] == 5:
    if data[data[i + 1]] != 0:
      i = data[data[i + 2]]
...
for i in range(41):
  for j in range(45):
    if i != 0 and i != 40 and j != 0 and j != 44 and area[i * 45 + j] == '#' and area[(i - 1) * 45 + j] == '#' and area[(i + 1) * 45 + j] == '#' and area[i * 45 + j - 1] == '#' and area[i * 45 + j + 1] == '#':
      summed += i * j
print(summed)