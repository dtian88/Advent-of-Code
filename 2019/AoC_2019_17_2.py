...
for c in main:
  input_queue.append(ord(c))
input_queue.append(10)
for c in A:
  input_queue.append(ord(c))
input_queue.append(10)
for c in B:
...
while True:
  if data[i] == 1:
    ...
    data[data[i + 1]] = input_queue.popleft()
    i += 2
  elif data[i] == 4:
    input_num = data[data[i + 1]]
    i += 2
  elif data[i] == 5:
    if data[data[i + 1]] != 0:
      i = data[data[i + 2]]
    ...
    if opcode == 1 or opcode == 2:
      ...
      if opcode == 3:
        if one == 1:
          num_one = input_queue.popleft()
        else:
          data[num_one] = input_queue.popleft()
      elif opcode == 4:
        if one == 1:
          input_num = num_one
        else:
          input_num = data[num_one]
      i += 2
